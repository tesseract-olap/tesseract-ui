declare namespace d3plus {
  namespace viz {
    class Viz<T> extends common.BaseClass<T> { }

    interface VizConfig<T> extends common.BaseClassConfig<T> {
      active([value])
       ...
       */
      thresholdKey: common.Accessor<T>;
